...
import { Phone, Mail, BriefcaseBusiness, User } from "lucide-react";
        ...
        <CardHeader className="pb-2">
          <CardTitle className="flex justify-between items-center">
            ...
            <Badge
              variant="outline"
              className={cn(
                "ml-2 whitespace-nowrap font-normal text-xs",
        ...
        <CardFooter className="pt-0 flex justify-between items-center">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Badge
                    ...
                    className={cn(
                      "font-normal",
                      getTechnologyColor(candidate.technology)
                    )}
                  >
          ...
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>
              ...
              {parseInt(candidate.experience) === 1 ? "yr" : "yrs"}
            </span>
          </div>
        </CardFooter>
      </Card>
